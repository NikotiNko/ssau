...
ok_installed      db 'LAB5 successful installed$'
already_msg       db 'LAB5 already installed$'
nomem_msg         db 'No free memory for loading LAB5$'
removed_msg       db 'LAB5 successful removed$'
noremove_msg      db 'Can not remove LAB5. Error$'
noinst_msg        db 'LAB5 not installed. Nothing remove$'
END